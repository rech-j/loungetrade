...
from apps.poker.routing import websocket_urlpatterns as poker_ws_patterns  # noqa: E402

all_websocket_patterns = coinflip_ws_patterns + chess_ws_patterns + poker_ws_patterns + notif_ws_patterns
